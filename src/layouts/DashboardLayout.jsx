...
const Sidebar = ({ user, isSidebarOpen }) => {
    const menuItems = [
        ...
        { to: "/ai-assistant", text: "Trợ lý AI", icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>, adminOnly: false },
        ...
        { to: "/du-thao", text: "Lấy ý kiến Dự thảo", icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>, adminOnly: false },
        ...
        { to: "/admin/knowledge", text: "Quản lý Tri thức AI", icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>, adminOnly: true },
        { to: "/admin/documents", text: "Quản lý Văn bản gốc", icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M7 8h10M7 12h10M7 16h6M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z" /></svg>, adminOnly: true },
        { to: "/admin/anchor-keywords", text: "Quản lý Từ khóa Neo", icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z" /></svg>, adminOnly: true },
    ];
    ...
    return (
        <aside className={`absolute inset-y-0 left-0 bg-white shadow-md w-64 transform transition-transform duration-300 ease-in-out z-30 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0`}>
            <SidebarHeader />
            <nav className="mt-4">
                {menuItems.map(item => ( // Logic kiểm tra role đã có sẵn
        ...
        <div className="relative min-h-screen md:flex">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <main className="flex-1 p-6 overflow-y-auto bg-gray-100">
                    <Outlet />
                    {/* Task FEW-04: Đặt ChatbotWidget ở đây để nó xuất hiện trên mọi trang */}
                    <ChatbotWidget />
                </main>
            </div>
        </div>
