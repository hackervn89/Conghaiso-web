...
const Sidebar = ({ user, isSidebarOpen }) => {
    const menuItems = [
        ...
        // Task FEW-05: Thêm link Trợ lý AI
        ...
        // Task FEW-01: Thêm link Quản lý AI
        { to: "/admin/knowledge", text: "Quản lý AI", icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>, adminOnly: true },
